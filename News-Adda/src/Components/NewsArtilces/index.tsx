...
const NewsArticles = () => {
    ...
    return (
        <>
            <TabGroup>
                <div className={`News-Articles h-full w-full ${theme == 'dark' ? "bg-violet-500  text-white border-violet-950" : "bg-violet-300 border-violet-900 hover:bg-violet-200"} border-0 rounded-t-xl`}>
                    ...
                    <TabPanels >
                        {categories.map((category) => (
                            <TabPanel key={category}>
                                <div id="Articles" className={` h-[70vh] w-full overflow-y-auto`}>
